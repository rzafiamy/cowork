...
SLASH_COMMANDS: list[tuple[str, str]] = [
    ...
    ("/acl",                     "List current file access control rules"),
    ("/acl log",                 "Show recent audited file operations"),
    ("/acl edit",                "Open acl.yaml rule editor"),
    ("/acl reset",               "Restore default security rules"),
